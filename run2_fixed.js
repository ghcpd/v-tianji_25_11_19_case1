...
// FIX 4: Deep clone using JSON serialization
function clone(obj) {
...
// FIX 1: Correct unsubscribe index
...
// FIX 2, 3, 7: Single await, clear items, and fix stale state check
